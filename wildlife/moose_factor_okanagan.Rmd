...
Searched SIWE for 'moose' in Okanagan and Thompson regions. found data form:
- 1985 SRB survey WMU 3-12
...
```{r, moose pop density, fig.cap = "Figure 1. Trends moose density in the Okanagan Timber Supply Area.", eval = T, echo = F, message = F, warning = F}
...
data.wmu.moose.trend <- data.wmu.moose %>%
                          filter (WILDLIFE_MGMT_UNIT_ID == "4-39" | WILDLIFE_MGMT_UNIT_ID == "8-1" | 
                                  ...
                                  WILDLIFE_MGMT_UNIT_ID == "8-9" | WILDLIFE_MGMT_UNIT_ID == "8-10" | 
                                  WILDLIFE_MGMT_UNIT_ID == "8-11" | WILDLIFE_MGMT_UNIT_ID == "8-12" | 
                                  WILDLIFE_MGMT_UNIT_ID == "8-14" | WILDLIFE_MGMT_UNIT_ID == "8-21" | 
                                  WILDLIFE_MGMT_UNIT_ID == "8-23" | WILDLIFE_MGMT_UNIT_ID == "8-24" | 
                                  WILDLIFE_MGMT_UNIT_ID == "8-25") # these units have >1 record
