...
### Road Density
Current road desnity (km/km^2^) was estimated at a AWA scale (Fig. ).
...
st_layers (dsn = "C:\\Work\\tsr\\data\\okanagan_tsr_20200407.gdb")

cutblocks <- sf::st_read (dsn = "C:\\Work\\tsr\\data\\okanagan_tsr_20200407.gdb",
                          layer = " ")
