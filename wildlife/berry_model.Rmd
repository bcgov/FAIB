...
Huckleberry tend to occur more in fire and harvest origin stands than stands of old, unknown origin. This could be that huckleberry are in younger stands, but there does seem to be a differnce between origin type.
...
Huckleberry fruit tend to occur more in old, unknown origin stands compared to fire and harvest origin stands.
...
Huckleberry cover was highest in fire origin stands (~22%) compared to harvest origin stands (~17%), and stands of old, unknown origin (~12%). This suggests that origin type matters, but the effect is pretty small.
...
Huckleberry fruit abundance was highest in fire origin stands compared to harvest origin stands, and stands of old, unknown origin (~10%). This also suggests that origin type matters, but the effect on fruit is different than on shrub cover.
...
Next I considered the effects of stand age of known origin stands on huckelberry measures.
...
data.prod.huck.na.origin <-  data.prod.huck.na.origin [Species.Cover != ""] # drop NA values
data.prod.huck.known.origin <- data.prod.huck.na.origin [origin != 0] # drop unknown origins



ggplot (data.prod.huck.known.origin, aes (x = origin.age, y = Species.Cover)) +
  geom_point () +
  geom_smooth () +
...
two lines for each origin

interaction age with origin
...
Stadn orgin apepars to inlfuence occurence of 
